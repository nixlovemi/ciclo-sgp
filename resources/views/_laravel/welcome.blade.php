        ...
        <nav class="navbar top-navbar navbar-expand-lg">
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    <!-- Logo icon -->
                    <a href="index.html">
                        <img src="/free-dash/assets/images/freedashDark.svg" alt="" class="img-fluid">
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                ...
                <ul class="navbar-nav float-end">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown"
                            ...
                            <img src="/free-dash/assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                width="40">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-right user-dd animated flipInY">
                            ...
                            <a class="dropdown-item" href="javascript:void(0)"><i data-feather="settings"
                                ...
                                Account Setting</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('site.login') }}"><i data-feather="power"
                                    class="svg-icon me-2 ms-1"></i>
                                Logout</a>
                            <div class="dropdown-divider"></div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="border-top-0 px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="me-3"><img
                                                            src="/free-dash/assets/images/users/widget-table-pic1.jpg"
                                        ...
                                        <tr>
                                            <td class="px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="me-3"><img
                                                            src="/free-dash/assets/images/users/widget-table-pic2.jpg"
                                                            alt="user" class="rounded-circle" width="45"
                                                            height="45" /></div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="me-3"><img
                                                            src="/free-dash/assets/images/users/widget-table-pic3.jpg"
                                                            alt="user" class="rounded-circle" width="45"
                                                            height="45" /></div>
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="border-bottom-0 px-2 py-4">
                                                <div class="d-flex no-block align-items-center">
                                                    <div class="me-3"><img
                                                            src="/free-dash/assets/images/users/widget-table-pic4.jpg"
                                                            alt="user" class="rounded-circle" width="45"
                                                            height="45" /></div>
                                                    <div class="">
